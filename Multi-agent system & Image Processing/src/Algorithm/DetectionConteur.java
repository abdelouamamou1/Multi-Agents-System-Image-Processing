...
public class DetectionConteur {
  
        
        public DetectionConteur() {}
        
        
        public String DetectConteur(String path) throws IOException {
	        ...
	        String newPath=path.substring(0, 42)+"ContourDetected"+path.substring(42, path.length());
